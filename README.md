...
[![Fabric](https://img.shields.io/badge/Fabric-26.1.2-1976D2?style=flat-square)](https://fabricmc.net/)
[![ko-fi](https://img.shields.io/badge/Ko--fi-aminoquiz-FF5E5B?style=flat-square)](https://ko-fi.com/aminoquiz)

Unofficial port of [Polymorph](https://github.com/illusivesoulworks/polymorph) by TheIllusiveC4 (Illusive Soulworks) to **Minecraft 26.1.2** on **NeoForge** and **Fabric**. Mod id is `polymorph_plus` (the original `polymorph` id is reserved for upstream).
