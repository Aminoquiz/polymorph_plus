 ...
 * extractWidgetRenderState(GuiGraphicsExtractor, ...) instead of renderWidget(GuiGraphics, ...).
 * blitSprite signature dropped the z-arg; GuiGraphics's renderItem/renderItemDecorations
 * became GuiGraphicsExtractor.item/itemDecorations. The new GuiGraphicsExtractor handles
