...
public class PolymorphNeoForgePacketDistributor implements IPolymorphNetwork {
  ...
  public void sendPlayerRecipeSelectionC2S(Identifier resourceLocation) {
    ClientPacketDistributor.sendToServer(new CPacketPlayerRecipeSelection(resourceLocation));
  }
  ...
  public void sendBlockEntityListenerC2S(boolean add) {
    ClientPacketDistributor.sendToServer(new CPacketBlockEntityListener(add));
  }
